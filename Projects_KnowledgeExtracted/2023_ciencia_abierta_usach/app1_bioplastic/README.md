...
<image src="/Projects_KnowledgeExtracted/2023_ciencia_abierta_usach/app1_bioplastic/resources/workflow/2 - config model.png" alt="config model">
...
<image src="/Projects_KnowledgeExtracted/2023_ciencia_abierta_usach/app1_bioplastic/resources/workflow/3 - charge file.png" alt="charge file">
4. Luego, debes seleccionar el articulo que deseas procesar.
<image src="/Projects_KnowledgeExtracted/2023_ciencia_abierta_usach/app1_bioplastic/resources/workflow/4 - select pdf.png" alt="select_pdf">
...
<image src="/Projects_KnowledgeExtracted/2023_ciencia_abierta_usach/app1_bioplastic/resources/workflow/5 - see pdf.png" alt="see pdf">
...
<image src="/Projects_KnowledgeExtracted/2023_ciencia_abierta_usach/app1_bioplastic/resources/workflow/6 - config agent.png" alt="confi">
...
<image src="/Projects_KnowledgeExtracted/2023_ciencia_abierta_usach/app1_bioplastic/resources/workflow/7 - select assistance.png" alt="Home">
8. Luego, ya puedes comenzar con tu asistente a solicitar información sobre el documento seleccionado 
<image src="/Projects_KnowledgeExtracted/2023_ciencia_abierta_usach/app1_bioplastic/resources/workflow/8 - response.png" alt="Home">
...
<image src="/Projects_KnowledgeExtracted/2023_ciencia_abierta_usach/app1_bioplastic/resources/workflow/9 - save item.png" alt="Home">
10. Para cualquier duda, sugerencia o comentario, no dude en contactarnos.
<image src="/Projects_KnowledgeExtracted/2023_ciencia_abierta_usach/app1_bioplastic/resources/workflow/10 - contact.png" alt="Home">
